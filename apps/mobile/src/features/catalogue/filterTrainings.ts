import type { CatalogueTraining } from "./useTrainings";

// Porté tel quel depuis apps/web/src/app/formations/_lib/filterTrainings.ts
// (logique pure, zéro dépendance DOM/Next) — v1 mobile ne branche une UI que
// pour q/catégorie (recherche + puces, cf. maquette Stitch), niveau/durée/
// certifiante/tri restent à leurs valeurs par défaut ("all"/"pertinence")
// en attendant un lot de polish qui leur ajoute une UI dédiée.
